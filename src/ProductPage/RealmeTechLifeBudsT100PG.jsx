...
import { realmeTechLifeBudsT100, realmeBudsAir2PGDetailed }  from '../Data/dataRealme'



function RealmeTechLifeBudsT100PG() {
        ...
        <Row>
            <Col sm={4}>
                ...
                <Carousel.Item>
                    ...
                    src={realmeTechLifeBudsT100[0].img0}
                    alt="First slide"
                    />
                </Carousel.Item>
                <Carousel.Item>
                    <img
                    className="d-block w-100"
                    src={realmeTechLifeBudsT100[0].img1}
                    alt="Second slide"
                    />
                </Carousel.Item>
                </Carousel>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{realmeTechLifeBudsT100[0].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{realmeTechLifeBudsT100[0].discountPrice} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold"> {realmeTechLifeBudsT100[0].color}</div></div>
                        <div className='d-flex gap-2 pt-2 pb-2'>
                            <OverlayTrigger placement="bottom" delay={{ show: 250, hide: 400 }} overlay={
                                <Tooltip id="button-tooltip">
                                    Black
                                </Tooltip>
                            }><Button style={{height: "35px", width: "35px",borderRadius: "100%",border: "none", backgroundColor: "#2C2C2C"}}></Button></OverlayTrigger>
                        </div>
                    </ListGroup.Item>
...
export default RealmeTechLifeBudsT100PG;