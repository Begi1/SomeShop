...
import { iPhone14ProPG, iPhone14ProPGMemory, iPhone14PGDetailed }  from '../Data/dataApple'
        ...
        <Row>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{iPhone14ProPG[color].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{iPhone14ProPGMemory[memory].discountPrice} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold"> {iPhone14ProPG[color].color}</div></div>
                    ...
                    <div className='d-flex gap-1'>Memory: <div className="fw-bold">{iPhone14ProPGMemory[memory].memory}</div></div>
        ...
        <Row className='pt-5'>
            <Table striped>
                ...
                <tbody>
                    ...
                    <td>{iPhone14ProPG[memory].memory}</td>
                    </tr>
                    <tr>
                    <td>RAM:</td>
