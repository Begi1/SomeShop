...
import XiaomiRedmiNote11 from '../Products/XiaomiPocoX4Pro'
import XiaomiRedmiNote11S from '../Products/XiaomiRedmiNote11S'

import { pocoX4ProPG, pocoX4ProPGMemory, blackShark5PGDetailed }  from '../Data/dataXiaomi'


function PocoX4ProPG() {
        ...
        <Row>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{pocoX4ProPG[color].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{pocoX4ProPGMemory[memory].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold"> {pocoX4ProPG[color].color}</div></div>
                        <div className='d-flex gap-2 pt-2 pb-2'>
                            ...
                            }><Button onClick={() => ChangeColor('Blue')} style={{height: "35px", width: "35px",borderRadius: "100%",border: "none", backgroundColor: "#2D6AA0"}}></Button></OverlayTrigger>
                            <OverlayTrigger placement="bottom" delay={{ show: 250, hide: 400 }} overlay={
                                <Tooltip id="button-tooltip">
                                    Yellow
                                </Tooltip>
                            }><Button onClick={() => ChangeColor('Yellow')} style={{height: "35px", width: "35px",borderRadius: "100%",border: "none", backgroundColor: "#E5C50E"}}></Button></OverlayTrigger>
                        </div>
                    </ListGroup.Item>
                    <ListGroup.Item className='pt-2 pb-2'>
                    <div className='d-flex gap-1'>Memory: <div className="fw-bold">{pocoX4ProPGMemory[memory].memory}</div></div>
        ...
        <Row className='pt-5'>
            <Table striped>
                ...
                <tbody>
                    ...
                    <td>{pocoX4ProPG[memory].memory}</td>
                    </tr>
                    <tr>
                    <td>RAM:</td>
