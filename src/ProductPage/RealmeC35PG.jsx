...
import { realmeC35PG, realmeC35PGMemory, realmeC35PGDetailed }  from '../Data/dataRealme'


function RealmeC35PG() {
        ...
        <Row>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{realmeC35PG[color].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{realmeC35PGMemory[memory].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold"> {realmeC35PG[color].color}</div></div>
                    ...
                    <div className='d-flex gap-1'>Memory: <div className="fw-bold">{realmeC35PGMemory[memory].memory}</div></div>
        ...
        <Row className='pt-5'>
            <Table striped>
                ...
                <tbody>
                    ...
                    <td>{realmeC35PGMemory[memory].memory}</td>
                    </tr>
                    <tr>
                    <td>RAM:</td>
