...
import { skullcandyIndyFuelTruePG, skullcandyJIBWithMICPGDetailed }  from '../Data/dataSkullcandy'
        ...
        <Row>
            <Col sm={4}>
                ...
                <Carousel.Item>
                    ...
                    src={skullcandyIndyFuelTruePG[color].img0}
                    alt="First slide"
                    />
                </Carousel.Item>
                <Carousel.Item>
                    <img
                    className="d-block w-100"
                    src={skullcandyIndyFuelTruePG[color].img1}
                    alt="Second slide"
                    />
                </Carousel.Item>
                </Carousel>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{skullcandyIndyFuelTruePG[color].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{skullcandyIndyFuelTruePG[0].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold"> {skullcandyIndyFuelTruePG[color].color}</div></div>
