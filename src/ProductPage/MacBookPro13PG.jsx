...
import { macBookPro13PG, macBooAir13M2PGDetailed }  from '../Data/dataApple'



function MacBookPro13PG() {
        ...
        <Row>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{macBookPro13PG[color].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{macBookPro13PG[0].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold">{macBookPro13PG[color].color}</div></div>
