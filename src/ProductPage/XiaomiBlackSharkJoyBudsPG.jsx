...
import { xiaomiBlackSharkJoyBuds, xiaomiBlackSharkJoyBudsPGDetailed }  from '../Data/dataXiaomi'



function XiaomiBlackSharkJoyBudsPG() {
        ...
        <Row>
            <Col sm={4}>
                ...
                <Carousel.Item>
                    ...
                    src={xiaomiBlackSharkJoyBuds[0].img0}
                    alt="First slide"
                    />
                </Carousel.Item>
                <Carousel.Item>
                    <img
                    className="d-block w-100"
                    src={xiaomiBlackSharkJoyBuds[0].img1}
                    alt="Second slide"
                    />
                </Carousel.Item>
                <Carousel.Item>
                    <img
                    className="d-block w-100"
                    src={xiaomiBlackSharkJoyBuds[0].img2}
                    alt="Third slide"
                    />
                </Carousel.Item>
                </Carousel>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{xiaomiBlackSharkJoyBuds[0].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{xiaomiBlackSharkJoyBuds[0].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold"> {xiaomiBlackSharkJoyBuds[0].color}</div></div>
...
export default XiaomiBlackSharkJoyBudsPG;