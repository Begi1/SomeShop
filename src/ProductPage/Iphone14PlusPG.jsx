...
import { iPhone14PG, iPhone14PlusPG, iPhone14PlusPGMemory, iPhone14PGDetailed }  from '../Data/dataApple'
        ...
        <Row>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{iPhone14PlusPG[color].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{iPhone14PlusPGMemory[memory].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                    ...
                    <ListGroup.Item className='pt-2 pb-2'>
                            <div className='d-flex gap-1'>Memory: <div className="fw-bold">{iPhone14PlusPGMemory[memory].memory}</div></div>
        ...
        <Row className='pt-5'>
            <Table striped>
                ...
                <tbody>
                    ...
                    <td>{iPhone14PlusPGMemory[memory].memory}</td>
                    </tr>
                    <tr>
                    <td>RAM:</td>
