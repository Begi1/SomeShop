...
import { realme9ProPG, realme9ProPGMemory, realmeC35PGDetailed }  from '../Data/dataRealme'


function Realme9ProPG() {
        ...
        <Row>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{realme9ProPG[color].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{realme9ProPGMemory[memory].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold"> {realme9ProPG[color].color}</div></div>
                    ...
                    <div className='d-flex gap-1'>Memory: <div className="fw-bold">{realme9ProPGMemory[memory].memory}</div></div>
        ...
        <Row className='pt-5'>
            <Table striped>
                ...
                <tbody>
                    ...
                    <td>{realme9ProPGMemory[memory].memory}</td>
                    </tr>
                    <tr>
                    <td>RAM:</td>
