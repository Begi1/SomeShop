...
import { macBooAir13M2PG, macBooAir13M2PGDetailed }  from '../Data/dataApple'



function MacBooAir13M2PG() {

    const [index, setIndex] = useState(0);
    const [color, setColor] = useState(0);

    function ChangeColor (WhichColor) {
        if(WhichColor === 'Midnight'){
          if(color === 1){
            setColor(color - 1)
          }else if(color === 2){
            setColor(color - 2)
        ...
        <Row>
            <Col sm={4}>
                ...
                <Carousel.Item>
                    ...
                    src={macBooAir13M2PG[color].img0}
                    alt="First slide"
                    />
                </Carousel.Item>
                <Carousel.Item>
                    <img
                    className="d-block w-100"
                    src={macBooAir13M2PG[color].img1}
                    alt="Second slide"
                    />
                </Carousel.Item>
                <Carousel.Item>
                    <img
                    className="d-block w-100"
                    src={macBooAir13M2PG[color].img2}
                    alt="Third slide"
                    />
                </Carousel.Item>
                </Carousel>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{macBooAir13M2PG[color].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{macBooAir13M2PG[0].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold">{macBooAir13M2PG[color].color}</div></div>
                        <div className='d-flex gap-2 pt-2 pb-2'>
                            ...
                            }><Button onClick={() => ChangeColor('Silver')} style={{height: "35px", width: "35px",borderRadius: "100%",border: "none", backgroundColor: "#DFDEE3"}}></Button></OverlayTrigger>
                            <OverlayTrigger placement="bottom" delay={{ show: 250, hide: 400 }} overlay={
                                <Tooltip id="button-tooltip">
                                    Space Grey
                                </Tooltip>                               
                            }><Button onClick={() => ChangeColor('Gray')} style={{height: "35px", width: "35px",borderRadius: "100%",border: "none", backgroundColor: "#AEAFB3"}}></Button></OverlayTrigger>
                            <OverlayTrigger placement="bottom" delay={{ show: 250, hide: 400 }} overlay={
                                <Tooltip id="button-tooltip">
                                    Starlight
                                </Tooltip>
                            }><Button onClick={() => ChangeColor('Starlight')} style={{height: "35px", width: "35px",borderRadius: "100%",border: "none", backgroundColor: "#EAE3D9"}}></Button></OverlayTrigger>
                        </div>
                    </ListGroup.Item>
...
export default MacBooAir13M2PG;