...
import { macBooAir13M1PG, macBooAir13M2PGDetailed }  from '../Data/dataApple'
        ...
        <Row>
            <Col sm={4}>
                ...
                <Carousel.Item>
                    ...
                    src={macBooAir13M1PG[color].img0}
                    alt="First slide"
                    />
                </Carousel.Item>
                <Carousel.Item>
                    <img
                    className="d-block w-100"
                    src={macBooAir13M1PG[color].img1}
                    alt="Second slide"
                    />
                </Carousel.Item>
                </Carousel>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{macBooAir13M1PG[color].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{macBooAir13M1PG[0].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold">{macBooAir13M1PG[color].color}</div></div>
                        <div className='d-flex gap-2 pt-2 pb-2'>
                            <OverlayTrigger placement="bottom" delay={{ show: 250, hide: 400 }} overlay={
                                <Tooltip id="button-tooltip">
                                    Silver
                                </Tooltip>
                            }><Button onClick={() => ChangeColor('Midnight')} style={{height: "35px", width: "35px",borderRadius: "100%",border: "none", backgroundColor: "#E3E4E6"}}></Button></OverlayTrigger>
                            <OverlayTrigger placement="bottom" delay={{ show: 250, hide: 400 }} overlay={
                                <Tooltip id="button-tooltip">
                                    Gold
                                </Tooltip>
                            }><Button onClick={() => ChangeColor('Silver')} style={{height: "35px", width: "35px",borderRadius: "100%",border: "none", backgroundColor: "#FBDAC7"}}></Button></OverlayTrigger>
                            <OverlayTrigger placement="bottom" delay={{ show: 250, hide: 400 }} overlay={
                                <Tooltip id="button-tooltip">
                                    Space Grey
                                </Tooltip>                               
