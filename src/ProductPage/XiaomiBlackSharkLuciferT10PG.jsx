...
import { xiaomiBlackSharkLuciferT10, xiaomiBlackSharkJoyBudsPGDetailed }  from '../Data/dataXiaomi'



function XiaomiBlackSharkLuciferT10PG() {
        ...
        <Row>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{xiaomiBlackSharkLuciferT10[0].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{xiaomiBlackSharkLuciferT10[0].discountPrice} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold"> {xiaomiBlackSharkLuciferT10[0].color}</div></div>
...
export default XiaomiBlackSharkLuciferT10PG;