...
import { realme9iPG, realme9iPGMemory, realmeC35PGDetailed }  from '../Data/dataRealme'
        ...
        <Row>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{realme9iPG[color].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{realme9iPGMemory[memory].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold"> {realme9iPG[color].color}</div></div>
                        <div className='d-flex gap-2 pt-2 pb-2'>
                            ...
                            }><Button onClick={() => ChangeColor('Blue')} style={{height: "35px", width: "35px",borderRadius: "100%",border: "none", backgroundColor: "#58A3CA"}}></Button></OverlayTrigger>
                        </div>
                    </ListGroup.Item>
                    <ListGroup.Item className='pt-2 pb-2'>
                    <div className='d-flex gap-1'>Memory: <div className="fw-bold">{realme9iPGMemory[memory].memory}</div></div>
        ...
        <Row className='pt-5'>
            <Table striped>
                ...
                <tbody>
                    ...
                    <td>{realme9iPGMemory[memory].memory}</td>
                    </tr>
                    <tr>
                    <td>RAM:</td>
