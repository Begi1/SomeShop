...
import { realmeBudsQ2s, realmeBudsAir2PGDetailed }  from '../Data/dataRealme'



function RealmeBudsQ2sPG() {
        ...
        <Row>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{realmeBudsQ2s[0].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{realmeBudsQ2s[0].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold"> {realmeBudsQ2s[0].color}</div></div>
...
export default RealmeBudsQ2sPG;