...
import { redmiNote11SPG, redmiNote11SPGMemory, blackShark5PGDetailed }  from '../Data/dataXiaomi'


function RedmiNote11SPG() {
        ...
        <Row>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{redmiNote11SPG[color].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{redmiNote11SPGMemory[memory].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold"> {redmiNote11SPG[color].color}</div></div>
                    ...
                    <div className='d-flex gap-1'>Memory: <div className="fw-bold">{redmiNote11SPGMemory[memory].memory}</div></div>
        ...
        <Row className='pt-5'>
            <Table striped>
                ...
                <tbody>
                    ...
                    <td>{redmiNote11SPG[memory].memory}</td>
                    </tr>
                    <tr>
                    <td>RAM:</td>
