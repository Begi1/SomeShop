...
import { iPhone14ProMaxPG, iPhone14ProMaxPGMemory, iPhone14PGDetailed }  from '../Data/dataApple'
        ...
        <Row>
            <Col sm={4}>
                ...
                <Carousel.Item>
                    ...
                    src={iPhone14ProMaxPG[color].img0}
                    alt="First slide"
                    />
                </Carousel.Item>
                <Carousel.Item>
                    <img
                    className="d-block w-100"
                    src={iPhone14ProMaxPG[color].img1}
                    alt="Second slide"
                    />
                </Carousel.Item>
                <Carousel.Item>
                    <img
                    className="d-block w-100"
                    src={iPhone14ProMaxPG[color].img2}
                    alt="Third slide"
                    />
                </Carousel.Item>
                </Carousel>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{iPhone14ProMaxPG[color].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{iPhone14ProMaxPGMemory[memory].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold"> {iPhone14ProMaxPG[color].color}</div></div>
                        <div className='d-flex gap-2 pt-2 pb-2'>
                            <OverlayTrigger placement="bottom" delay={{ show: 250, hide: 400 }} overlay={
                                <Tooltip id="button-tooltip">
                                    Purple
                                </Tooltip>
                            }><Button onClick={() => ChangeColor('Purple')} style={{height: "35px", width: "35px",borderRadius: "100%",border: "none", backgroundColor: "#413948"}}></Button></OverlayTrigger>
                            <OverlayTrigger placement="bottom" delay={{ show: 250, hide: 400 }} overlay={
                                <Tooltip id="button-tooltip">
                                    Gold
                                </Tooltip>
                            }><Button onClick={() => ChangeColor('Gold')} style={{height: "35px", width: "35px",borderRadius: "100%",border: "none", backgroundColor: "#F2E4C9"}}></Button></OverlayTrigger>
                            <OverlayTrigger placement="bottom" delay={{ show: 250, hide: 400 }} overlay={
                                <Tooltip id="button-tooltip">
                                    Silver
                                </Tooltip>                               
                            }><Button onClick={() => ChangeColor('Silver')} style={{height: "35px", width: "35px",borderRadius: "100%",border: "none", backgroundColor: "#EFF1F0"}}></Button></OverlayTrigger>
                            <OverlayTrigger placement="bottom" delay={{ show: 250, hide: 400 }} overlay={
                                <Tooltip id="button-tooltip">
                                    Black
                                </Tooltip>
                            }><Button onClick={() => ChangeColor('Black')} style={{height: "35px", width: "35px",borderRadius: "100%",border: "none", backgroundColor: "#2F2E2C"}}></Button></OverlayTrigger>
                        </div>
                    </ListGroup.Item>
                    <ListGroup.Item className='pt-2 pb-2'>
                    <div className='d-flex gap-1'>Memory: <div className="fw-bold">{iPhone14ProMaxPGMemory[memory].memory}</div></div>
        ...
        <Row className='pt-5'>
            <Table striped>
                ...
                <tbody>
                    ...
                    <td>{iPhone14ProMaxPG[memory].memory}</td>
                    </tr>
                    <tr>
                    <td>RAM:</td>
