...
import { xiaomiRedmiBuds3, xiaomiBlackSharkJoyBudsPGDetailed }  from '../Data/dataXiaomi'



function XiaomiRedmiBuds3() {
        ...
        <Row>
            ...
            <Col>
                <ListGroup variant="flush">
                    <ListGroup.Item className="fw-bold pt-3 pb-3">{xiaomiRedmiBuds3[0].title}</ListGroup.Item>
                    <ListGroup.Item className='d-flex gap-2 pt-3 pb-3'>Price: <div className="fw-bold">{xiaomiRedmiBuds3[0].price} ₾</div></ListGroup.Item>
                    <ListGroup.Item>
                        <div className='d-flex gap-1'>Color: <div className="fw-bold"> {xiaomiRedmiBuds3[0].color}</div></div>
...
export default XiaomiRedmiBuds3;