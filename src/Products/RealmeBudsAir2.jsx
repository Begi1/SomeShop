...
import { realmeBudsAir2 }  from '../Data/dataRealme'


function RealmeBudsAir2() {
    ...
    <div>
      <Card  className="text-center" style={{border: "none", background: '#F5F5F5'}}>
        <Carousel interval='50000' variant = 'dark' activeIndex={index} onSelect={handleSelect} fade='true'>
          ...
          <Card.Body>
            <Link to="/RealmeBudsAir2">{realmeBudsAir2[0].title}</Link>
            <Container>
              <Row className='pt-3 justify-content-md-center'>
                <Col md="auto">
                  <Card.Text>{realmeBudsAir2[0].price + " ₾"}</Card.Text>
                </Col>
              </Row>
              <Row xs={1} md={2}>
