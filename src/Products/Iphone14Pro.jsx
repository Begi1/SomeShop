...
import { iPhone14Pro } from '../Data/dataApple'
  ...
  return (
    <div>
        ...
        <Carousel interval='10000' variant = 'dark' activeIndex={index} onSelect={handleSelect} fade='true'>
          ...
          <Card.Body >
            <Link to="/Iphone14Pro">{iPhone14Pro[0].title}</Link>
            <Container>
              <Row className='pt-3 justify-content-md-center'>
                <Col md="auto">
                  <Card.Text><s>{iPhone14Pro[0].price + " ₾"}</s></Card.Text>
                </Col>
                <Col md="auto">
                  <Card.Text>{iPhone14Pro[0].discountPrice + " ₾"}</Card.Text>
                </Col>
              </Row>
              <Row xs={1} md={2}>
