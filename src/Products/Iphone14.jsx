...
import { iPhone14 }  from '../Data/dataApple'
...
function Iphone14() {
  ...
  return (
    <div>
      <Card indicators='false' className="text-center" style={{border: "none", background: '#F5F5F5'}}>
        <Carousel  interval='10000' variant = 'dark' activeIndex={index} onSelect={handleSelect} fade='true'>
          ...
          <Card.Body>
            <Link to="/Iphone14">{iPhone14[0].title}</Link>
            <Container>
              <Row className='pt-3 justify-content-md-center'>
                <Col md="auto">
                  <Card.Text>{iPhone14[0].price + " ₾"}</Card.Text>
                </Col>
              </Row>
              <Row xs={1} md={2}>
