...
import { pocoX4Pro }  from '../Data/dataXiaomi'
      ...
      <Card  className="text-center" style={{border: "none", background: '#F5F5F5'}}>
        <Carousel  interval='10000' variant = 'dark' activeIndex={index} onSelect={handleSelect} fade='true'>
              ...
              <Carousel.Item>
                  <img
                  className="d-block w-100"
                  src={pocoX4Pro[0].img2}
                  alt="Third slide"
                  />
                </Carousel.Item>
        </Carousel>
          <Card.Body>
            <Link to="/PocoX4Pro">{pocoX4Pro[0].title}</Link>
            <Container>
              <Row className='pt-3 justify-content-md-center'>
                <Col md="auto">
                  <Card.Text>{pocoX4Pro[0].price + " ₾"}</Card.Text>
                </Col>
              </Row>
              <Row xs={1} md={2}>
