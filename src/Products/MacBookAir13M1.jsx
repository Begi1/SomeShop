...
import { macbookAir13M1 } from '../Data/dataApple'


function MacbookAir13M1() {
  ...
  return (
    <div>
        ...
        <Carousel interval='20000' variant = 'dark' activeIndex={index} onSelect={handleSelect} fade='true'>
          ...
          <Card.Body>
            <Link to="/MacBookAir13M1">{macbookAir13M1[0].title}</Link>
            <Container>
              <Row className='pt-3 justify-content-md-center'>
                <Col md="auto">
                  <Card.Text>{macbookAir13M1[0].price + " ₾"}</Card.Text>
                </Col>
              </Row>
              <Row xs={1} md={2}>
