...
import { iPhone14Plus } from '../Data/dataApple'
  ...
  return (
    <div>
        ...
        <Carousel interval='10000'variant = 'dark' activeIndex={index} onSelect={handleSelect} fade='true'>
          ...
          <Card.Body>
            <Link to="/Iphone14Plus">{iPhone14Plus[0].title}</Link>
            <Container>
              <Row className='pt-3 justify-content-md-center'>
                <Col md="auto">
                  <Card.Text>{iPhone14Plus[0].price + " ₾"}</Card.Text>
                </Col>
              </Row>
              <Row xs={1} md={2}>
